...
class io_minion extends IO {
    ...
    think(input) {
        ...
        if (input.target != null && (input.alt || input.main)) {
            ...
            let leash = (90 * sizeFactor) * this.body.master.fov;
            let leashEnd = (145 * sizeFactor) * this.body.master.fov;
        ...
        connect: (() => {
            ...
            const spawn = (() => {
                ...
                return (socket, name) => {
                    ...
                    body.sendMessage('The Idea of Defender is to Protect the Main Base for 10 whole waves.');
